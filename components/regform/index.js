...
const index = () => {
    ...
    const [form, setForm] = useState({ name: '', inst: '', state: '', phone: '', id: '', yof: ''})
  ...
  return (
    <>
	  ...
	  <div className={styles.part1}> 
				...
				<fieldset className={styles.fieldset}>
					<label>State</label>
					<input type='text' name='email' value={form.state} onChange={handleChange} required />
				</fieldset>
				<fieldset className={styles.fieldset}>
				...
				<fieldset className={styles.fieldset}>
					...
					<input type='text' name='email' value={form.id} onChange={handleChange} required />
				</fieldset>
				<fieldset className={styles.fieldset}>
					<label>Year Of Study</label>
					<input type='text' name='email' value={form.yof} onChange={handleChange} required />
				</fieldset>
				<fieldset className={styles.fieldset}>
