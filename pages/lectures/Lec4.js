  ...
  return (
    <>
       ...
       <div className={styles.pic12_container}> 
        ...
        <p className={styles.desc}>Glow, baby, glow. From fireflies to glow worms, bioluminescence is
ready to bright the future. We are trying to create a hybrid of the bioluminescent
creatures and the wonders of the futuristic world in order to
create a virtual companion.


Problem statement : To create a faux pet with bioluminescence in the metaverse.
...
Guidelines:
    ...
    <ul>
      ...
      <li>●	A visual representation of the pet to be provided with a character description </li>
      <li>●	Any 3d modeling software may be used as per convenience.</li>
