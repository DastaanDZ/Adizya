...
Guidelines: 
    ...
    <ul>
      <li>A set of materials will be provided with which participants are required to design a furniture. Materials like PVC pipes, bottle and its cap, </li>
      <li>The given materials can be deformed to your suitable requirements.</li>
      <li>File type - JPG, PNG, PDF. (Not more than 10 MB)</li>
      <li>Submissions can be made using softwares or hand-drawn sketches.</li>
      <li>Submission & Registration for the competition is to be done adizya.org</li>
    </ul>
</p>
...
The winner will also get a chance to sell their furniture to the sponsor company.</p>
...
Result: 28-02-2022
       ...
       <a href='https://forms.gle/CHkNXiWDoeWHiG9v9' className={styles.register_btn}>REGISTER</a>
       </div>
       </div> 
    </>
  )
