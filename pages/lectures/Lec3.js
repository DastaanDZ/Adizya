  ...
  return (
    <>
       ...
       <div className={styles.pic12_container}> 
        ...
        <p className={styles.desc}>Helmut Jahn once said that every building is a prototype and
...
Result: 28-02-2022
       ...
       <a href='https://forms.gle/MuKNwVGSBpstit4p7' className={styles.register_btn}>REGISTER</a>
       </div>
       </div> 
    </>
  )
