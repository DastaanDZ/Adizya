...
const Eve7 = ({ name, email, inst, state, phoneNo, adyziaId }) => {
  return (
    <>
      <div>
        ...
        <div className={styles.info}>
          ...
          <p className={styles.desc}>
            Our world has witnessed unprecedented conditions, while secluding
            oneself in a closed space has allowed our minds to run freely with
            the possibilities of various horrific scenarios, and it is now time
            to express these freely and lighten our burden and visualize these
            in an alternate realm of metaverse. Problem statement : To reimagine
            a post-apocalyptic scenario Entry Fees: Free Guidelines:
            <ul>
        ...
        <div className={styles.btn_container}>
          <a
            href={`https://docs.google.com/forms/d/e/1FAIpQLSda4SjWJCnxpfEzsLZba87DsrGToRr827gRwoQ0kWienLJMyw/viewform?usp=pp_url&entry.2059373958=${name}&entry.1878980868=${email}&entry.619268215=${inst}&entry.1044151569=${state}&entry.410368050=${phoneNo}&entry.1914638317=${adyziaId}`}
